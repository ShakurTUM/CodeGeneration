...
public class PaymentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PaymentPackage.PAYMENT: {
				Payment payment = (Payment)theEObject;
				T result = casePayment(payment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PaymentPackage.INVOICE: {
				Invoice invoice = (Invoice)theEObject;
				T result = caseInvoice(invoice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PaymentPackage.CUSTOMER: {
				Customer customer = (Customer)theEObject;
				T result = caseCustomer(customer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PaymentPackage.CASH: {
				Cash cash = (Cash)theEObject;
				T result = caseCash(cash);
				if (result == null) result = casePayment(cash);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PaymentPackage.CREDIT_CARD: {
				CreditCard creditCard = (CreditCard)theEObject;
				T result = caseCreditCard(creditCard);
				if (result == null) result = casePayment(creditCard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PaymentPackage.BANK: {
				Bank bank = (Bank)theEObject;
				T result = caseBank(bank);
				if (result == null) result = casePayment(bank);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PaymentPackage.PROMO_CODE: {
				PromoCode promoCode = (PromoCode)theEObject;
				T result = casePromoCode(promoCode);
				if (result == null) result = casePayment(promoCode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PaymentPackage.PAYPAL: {
				Paypal paypal = (Paypal)theEObject;
				T result = casePaypal(paypal);
				if (result == null) result = casePayment(paypal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Promo Code</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Promo Code</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePromoCode(PromoCode object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Paypal</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Paypal</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePaypal(Paypal object) {
		return null;
	}
