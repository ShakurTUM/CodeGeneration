 ...
 * <!-- end-user-doc -->
 * @see com.tum.vsms.Maintenance.Maintenance.MaintenancePackage#getMaintenanceStatus()
 * @model
 * @generated
 */
public enum MaintenanceStatus implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final MaintenanceStatus[] VALUES_ARRAY =
	 ...
	 * @generated
	 */
	public static final List<MaintenanceStatus> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static MaintenanceStatus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MaintenanceStatus result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static MaintenanceStatus getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MaintenanceStatus result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static MaintenanceStatus get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private MaintenanceStatus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
