...
public class UserFactoryImpl extends EFactoryImpl implements UserFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case UserPackage.ADMIN: return createAdmin();
			case UserPackage.CUSTOMER: return createCustomer();
			case UserPackage.OPERATIVE: return createOperative();
			default:
	...
	public Operative createOperative() {
		OperativeImpl operative = new OperativeImpl();
		return operative;
	}
