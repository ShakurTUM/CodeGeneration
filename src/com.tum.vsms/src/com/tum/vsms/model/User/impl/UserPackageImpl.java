...
import com.tum.vsms.model.User.Admin;
...
import com.tum.vsms.model.User.User;
import com.tum.vsms.model.User.UserFactory;
...
public class UserPackageImpl extends EPackageImpl implements UserPackage {
	 ...
	 * @generated
	 */
	private EClass operativeEClass = null;
	 ...
	 * @see com.tum.vsms.model.User.UserPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getAdmin_Role() {
	 ...
	 * @generated
	 */
	public EOperation getAdmin__AdminOperation() {
	 ...
	 * @generated
	 */
	public EAttribute getCustomer_DrivingLicense() {
	 ...
	 * @generated
	 */
	public EAttribute getCustomer_Passport() {
	 ...
	 * @generated
	 */
	public EAttribute getCustomer_Insurance() {
	 ...
	 * @generated
	 */
	public EOperation getCustomer__Login() {
	 ...
	 * @generated
	 */
	public EOperation getCustomer__Logout() {
	 ...
	 * @generated
	 */
	public EOperation getCustomer__Register() {
	 ...
	 * @generated
	 */
	public EClass getOperative() {
		return operativeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getOperative_Position() {
		return (EAttribute)operativeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getOperative__MaintenanceOperation() {
		return operativeEClass.getEOperations().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(adminEClass, ADMIN__ROLE);
		createEOperation(adminEClass, ADMIN___ADMIN_OPERATION);

		customerEClass = createEClass(CUSTOMER);
		createEAttribute(customerEClass, CUSTOMER__DRIVING_LICENSE);
		createEAttribute(customerEClass, CUSTOMER__PASSPORT);
		createEAttribute(customerEClass, CUSTOMER__INSURANCE);
		createEOperation(customerEClass, CUSTOMER___LOGIN);
		createEOperation(customerEClass, CUSTOMER___LOGOUT);
		createEOperation(customerEClass, CUSTOMER___REGISTER);

		operativeEClass = createEClass(OPERATIVE);
		createEAttribute(operativeEClass, OPERATIVE__POSITION);
		createEOperation(operativeEClass, OPERATIVE___MAINTENANCE_OPERATION);
	...
	public void initializePackageContents() {
		...
		operativeEClass.getESuperTypes().add(this.getUser());
		...
		initEAttribute(getAdmin_Role(), this.getRole(), "role", null, 0, 1, Admin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getAdmin__AdminOperation(), null, "adminOperation", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(customerEClass, Customer.class, "Customer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCustomer_DrivingLicense(), ecorePackage.getEString(), "drivingLicense", null, 0, 1, Customer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCustomer_Passport(), ecorePackage.getEString(), "passport", null, 0, 1, Customer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCustomer_Insurance(), ecorePackage.getEString(), "insurance", null, 0, 1, Customer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getCustomer__Login(), null, "login", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getCustomer__Logout(), null, "logout", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getCustomer__Register(), null, "register", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(operativeEClass, Operative.class, "Operative", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOperative_Position(), this.getLevel(), "position", null, 0, 1, Operative.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getOperative__MaintenanceOperation(), null, "maintenanceOperation", 0, 1, IS_UNIQUE, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(roleEEnum, Role.class, "Role");
		addEEnumLiteral(roleEEnum, Role.MANAGER);
		addEEnumLiteral(roleEEnum, Role.DB_ADMIN);
		addEEnumLiteral(roleEEnum, Role.HUMAN_RESOURCE);
