...
import com.tum.vsms.Location.Location.Destination;
import com.tum.vsms.Location.Location.Location;
import com.tum.vsms.Location.Location.LocationFactory;
import com.tum.vsms.Location.Location.LocationPackage;
import com.tum.vsms.Location.Location.Origin;
...
public class LocationPackageImpl extends EPackageImpl implements LocationPackage {
	 ...
	 * @see com.tum.vsms.Location.Location.LocationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static LocationPackage init() {
		...
		Object registeredLocationPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		LocationPackageImpl theLocationPackage = registeredLocationPackage instanceof LocationPackageImpl ? (LocationPackageImpl)registeredLocationPackage : new LocationPackageImpl();
	...
	public void initializePackageContents() {
		...
		originEClass.getESuperTypes().add(this.getLocation());
		destinationEClass.getESuperTypes().add(this.getLocation());
		...
		initEReference(getLocation_Address(), this.getAddress(), null, "address", null, 0, 1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
